...
void test1add_function(); __attribute__((constructor)) void add_test1add_function() { func_arr[cnt++] = test1add_function; } void test1add_function() {
    ({ if (add(3, 4) == 7) { printf("YES\n"); } else { printf("NO\n"); }});
    ({ if (add(0, 0) == 0) { printf("YES\n"); } else { printf("NO\n"); }});
    ({ if (add(-1, -7) == -8) { printf("YES\n"); } else { printf("NO\n"); }});
}


void test2add_function(); __attribute__((constructor)) void add_test2add_function() { func_arr[cnt++] = test2add_function; } void test2add_function() {
    ({ if (add(3, 4) == 7) { printf("YES\n"); } else { printf("NO\n"); }});
    ({ if (add(0, 0) == 0) { printf("YES\n"); } else { printf("NO\n"); }});
    ({ if (add(-1, -7) == -8) { printf("YES\n"); } else { printf("NO\n"); }});
}
